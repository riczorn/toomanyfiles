...
$langpath =JPATH_ADMINISTRATOR.'/components/com_toomanyfiles';
$language = JFactory::getLanguage();
$language->load('com_toomanyfiles', $langpath, 'en-GB', true);
$language->load('com_toomanyfiles', $langpath, null, true);


$controller = JControllerLegacy::getInstance('TooManyFiles');
